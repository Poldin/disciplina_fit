...
export default function SubscriptionDialog({ isOpen, onClose, disciplineSlug }: SubscriptionDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Dialog */}
      <div className="relative bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl w-full max-w-md mx-2 p-8 border border-zinc-200 dark:border-zinc-800 max-h-screen">
        {/* Close Button */}
        <button
          onClick={handleClose}
        ...
        >
          {isLoading ? "Reindirizzamento a Stripe..." : "Inizia e non mollare!"}
        </button>
