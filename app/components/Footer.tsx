      ...
      <div className="max-w-7xl mx-auto px-1 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-zinc-200 dark:border-zinc-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-zinc-500 dark:text-zinc-500">
            © 2026 disciplinaFit. Tutti i diritti riservati.
          </p>
          <div className="flex gap-6 mt-4 md:mt-0">
            <a href="https://www.instagram.com/disciplina_f_i_t/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-50 transition-colors">
              ...
              <span className="text-sm font-bold">disciplina_f_i_t</span>
            </a>
          </div>
        </div>
      </div>
